...
let restaurantPage = require(`../pages/filters/FilterRestaurantsPanel`);
...
exports.getCountRatedRestaurants = function (typeFilter, restaurants = []) {
    ...
    restaurants.forEach((el) => console.log(el[prop]['rating']));
    console.log('********************');
    restaurants.forEach((el) => console.log(el[prop]['count']));
 ...
 * @returns {promise.Promise<any>}
 */
exports.addRandomDishesToOrder = function(count) {
